...
func TestPolyPrem(t *testing.T) {

	// vars(a,b,x);
	// F=125000*a*x^3+((-1080000*a^3+6705000*a^2-405000*a)*b-8680000*a^3+53830000*a^2-2817500*a-125000)*x^2+((9331200*a^5-115862400*a^4+366654600*a^3-43448400*a^2+1312200*a)*b^2+(149990400*a^5-1861372800*a^4+5879815200*a^3-649999800*a^2+11552400*a+405000)*b+602739200*a^5-7475910400*a^4+23572645600*a^3-2417976400*a^2+9676450*a+3442500)*x+(-80621568*a^7+1501576704*a^6-9412987968*a^5+20418141096*a^4-3529870488*a^3+211159224*a^2-4251528*a)*b^3+(-1943875584*a^7+36191619072*a^6-226697413824*a^5+490564865808*a^4-81082536084*a^3+4266583632*a^2-45282564*a-1312200)*b^2+(-15623000064*a^7+290768389632*a^6-1819885100544*a^5+3928724922528*a^4-619408377504*a^3+27921342942*a^2+67322106*a-20157400)*b-41854210048*a^7+778690827264*a^6-4869896306688*a^5+10487735402816*a^4-1573276721408*a^3+58429207284*a^2+1264371017*a-77593950:
	// G=108*a^2*b^2+(-180*a+11)*b-2240*a^2-1908*a+100:

	f := NewPolyCoef(2,
		NewPolyCoef(1,
			NewPolyCoef(0, -77593950, 1264371017, 58429207284, -1573276721408, 10487735402816, -4869896306688, 778690827264, -41854210048),
			NewPolyCoef(0, -20157400, 67322106, 27921342942, -619408377504, 3928724922528, -1819885100544, 290768389632, -15623000064),
			NewPolyCoef(0, -1312200, -45282564, 4266583632, -81082536084, 490564865808, -226697413824, 36191619072, -1943875584),
			NewPolyCoef(0, 0, -4251528, 211159224, -3529870488, 20418141096, -9412987968, 1501576704, -80621568)),
		NewPolyCoef(1,
			NewPolyCoef(0, 3442500, 9676450, -2417976400, 23572645600, -7475910400, 602739200),
			NewPolyCoef(0, 405000, 11552400, -649999800, 5879815200, -1861372800, 149990400),
			NewPolyCoef(0, 0, 1312200, -43448400, 366654600, -115862400, 9331200)),
		NewPolyCoef(1,
			NewPolyCoef(0, -125000, -2817500, 53830000, -8680000),
			NewPolyCoef(0, 0, -405000, 6705000, -1080000)),
		NewPolyCoef(0, 0, 125000))
	g := NewPolyCoef(1, NewPolyCoef(0, 100, -1908, -2240), NewPolyCoef(0, 11, -180), NewPolyCoef(0, 0, 0, 108))

	expect := NewPolyCoef(2, NewPolyCoef(1, NewPolyCoef(0, 0, -801900, 70679952, -2272336416, 28987170364, -15076567106, -2544221051168, 12130144982624, 32679677963776, -17761761257472, 2984406190080, -164343259136), NewPolyCoef(0, 0, -88209, 7535187, -227512233, 2391928029, 11024940942, -348279773652, 981711115056, 7614418070592, -3856443070464, 634496191488, -34590302208)), NewPolyCoef(1, NewPolyCoef(0, 0, 0, 0, -2430000, 133709400, -2140381900, 6531432400, 58243582400, -19428262400, 1592550400), NewPolyCoef(0, 0, 0, 0, -267300, 14034600, -196412100, -54216000, 11371521600, -3691641600, 299980800)), NewPolyCoef(1, NewPolyCoef(0, 0, 0, 0, 0, -250000, -5635000, 107660000, -17360000), NewPolyCoef(0, 0, 0, 0, 0, 0, -810000, 13410000, -2160000)), NewPolyCoef(0, 0, 0, 0, 0, 0, 250000))

	lv := g.lv
	h := f.prem(g)
	if h.Deg(lv) >= g.Deg(lv) {
		t.Errorf("degree error: h[%d]=%v", lv, h)
	}
	for _, lvx := range []Level{0, 1, 2, 3} {
		if h.Deg(lvx) != expect.Deg(lvx) {
			t.Errorf("degree[%s] error: actual=%v, expect=%v: %v", VarStr(lvx), h.Deg(lvx), expect.Deg(lvx), h)
		}
	}
	if !h.Equals(expect) {
		t.Errorf("nooooo: \nh[%d]=%v\ne[%d]=%v", lv, h, lv, expect)
	}
